...
public abstract class DataFile<D> extends IntRegistry<IDataIO<D>> {
    ...
    public D loadData() throws Exception {
        ...
        if (io == null) {
            ...
            if (io != null) {
                ...
                ParticleWorkshopPlugin.log.warning("Unknown data format. Please contact author to fix it... [VERSION=" + version + "]");
            }
        } else {
            data = io.load(dis);
        }
